...
final addReviewsProvider =
    StateNotifierProvider<AddReviewController, BaseState>(
  (ref) => AddReviewController(ref: ref),
);

/// Controllers
class AddReviewController extends StateNotifier<BaseState> {
  final Ref? ref;

  AddReviewController({this.ref}) : super(const InitialState());
  File? imgFile;
  ...
  Future addReview({
    ...
    try {
      final request = http.MultipartRequest(
        'POST',
        Uri.parse('${API.base}' '${API.addReview}'),
      )
